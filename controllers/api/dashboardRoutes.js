/* These are the Express routes to load various routes related to user login security
...
user_id should match the post data this is for the user 'Dashboard' */
router.get("/", withAuth, async (req, res) => {
    ...
    // To turn medatada off, we use the plain: true option, also use 'map' with findAll
...
// this route allows the logged in User to edit their posts in the 'Dashboard' page
